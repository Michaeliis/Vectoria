							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Register Location</h2>
									</header>
									<div class="panel-body">
                                        
										<form class="form-horizontal form-bordered" method="POST" action="<?= base_url('location/insert')?>">
                                            <!-- Map -->
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
													<select id="pic" name="pic" class="form-control mb-md" required>
